...
define([
  ...
  'dojo/text!./templates/DrawBoxRec.html',
  'dojo/_base/lang',
  'dojo/_base/html',
  'dojo/_base/array',
  'dojo/on',
            ...
            */
            ...
            _initTypes: function () {
                if (this.geoTypes && this.geoTypes.length > 0) {
                    ...
                    if (this.types.indexOf('polyline') >= 0) {
                        this.geoTypes = this.geoTypes.concat(["LINE", "POLYLINE"]);
                    }
                    if (this.types.indexOf('polygon') >= 0) {
                        var a = ["TRIANGLE", "EXTENT", "CIRCLE", "ELLIPSE", "POLYGON"];
            ...
            _onDrawEnd: function (event) {
                ...
                if (event.geometry.type === 'extent') {
                    ...
                    geometry = event.geometry; //Polygon.fromExtent(event.geometry);
                } else {
